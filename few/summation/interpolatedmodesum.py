...
class InterpolatedModeSumKerrCircular_full(SummationBase, KerrCircular_full, ParallelModuleBase):
    """Create waveform by interpolating sparse trajectory.
    ...
    def __init__(self, *args, **kwargs):
        ...
        ParallelModuleBase.__init__(self, *args, **kwargs)
        KerrCircular_full.__init__(self, *args, **kwargs)
        SummationBase.__init__(self, *args, **kwargs)
    ...
    def attributes_InterpolatedModeSumKerrCircular_full(self):
        """
        attributes:
            get_waveform (func): CPU or GPU function for waveform creation.
