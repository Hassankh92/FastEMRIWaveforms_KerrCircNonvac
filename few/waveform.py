...
from few.utils.baseclasses import SchwarzschildEccentric, Pn5AAK, ParallelModuleBase, KerrCircular, KerrCircular_full
from few.trajectory.inspiral import EMRIInspiral
from few.amplitude.interp2dcubicspline import Interp2DAmplitude, Interp2DAmplitudeKerrCircular, Interp2DAmplitudeKerrCircular_full
...
from few.summation.interpolatedmodesum import InterpolatedModeSum, CubicSplineInterpolant, InterpolatedModeSumKerrCircular, InterpolatedModeSumKerrCircular_full
...
##################################################################################################################################
class RelativisticKerrCircularWaveformBase_full(KerrCircular_full, ParallelModuleBase, ABC):

    def attributes_RelativisticKerrCircularWaveformBase_full(self):
        """
        attributes:
            inspiral_generator (obj): instantiated trajectory module.
            amplitude_generator (obj): instantiated amplitude module.
    ...
    def __init__(
        ...
        ParallelModuleBase.__init__(self, use_gpu=use_gpu, num_threads=num_threads)
        KerrCircular_full.__init__(self, use_gpu=use_gpu)
    ...
    def __call__(
        ...
        *args,
        ...
        # makes sure viewing angles are allowable
        theta, phi = self.sanity_check_viewing_angles(theta, phi)
        self.sanity_check_init_full(M, mu, a0, p0, e0)
        ...
        # makes sure p and e are generally within the model
        self.sanity_check_traj_full(a, p, e)
...
class KerrCircularFlux_full(RelativisticKerrCircularWaveformBase_full):
    ...
    def attributes_KerrCircularFlux_full(self):
        """
        attributes:
            gpu_capability (bool): If True, this wavefrom can leverage gpu
                resources. For this class it is False.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # declare specific properties
        # inspiral_kwargs["DENSE_STEPPING"] = 0
        inspiral_kwargs["func"] = "KerrCircFlux_full"

        RelativisticKerrCircularWaveformBase.__init__(
            self,
            EMRIInspiral,
            Interp2DAmplitudeKerrCircular_full,
            InterpolatedModeSumKerrCircular_full,
            inspiral_kwargs=inspiral_kwargs,
            amplitude_kwargs=amplitude_kwargs,
            sum_kwargs=sum_kwargs,
            Ylm_kwargs=Ylm_kwargs,
